...
test.describe('New Todo', () => {
    test.only('Verify that user can add Hash Key', async({ page }) => {
        ...
        await expect(notification).toContain('Key has been added');
        // Check that new key is displayed in the list
        await browserPage.searchByKeyName(keyName);
        const isKeyIsDisplayedInTheList = await browserPage.isKeyIsDisplayedInTheList(keyName);
        await expect(isKeyIsDisplayedInTheList).toBeTruthy();
    });
